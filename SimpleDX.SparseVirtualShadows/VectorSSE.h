...
*/
    ...
    __forceinline const VFixPt4 operator>>( UINT val ) const
    {
        VFixPt4 tmp;
        tmp.mX = _mm_srai_epi32( mX, val );
        tmp.mY = _mm_srai_epi32( mY, val );
        tmp.mZ = _mm_srai_epi32( mZ, val );
        tmp.mW = _mm_srai_epi32( mW, val );
        return tmp;
    }
...
__forceinline VFloat operator-( const float v0, const VFloat &v1 )
{
    VFloat tmp;
...
__forceinline VFloat Max( const float v0, const VFloat &v1 )
{
    VFloat tmp;
...
__forceinline VFloat Min( const float v0, const VFloat &v1 )
{
    VFloat tmp;
...
__forceinline VFloat Min( const VFloat &v0, const float v1 )
{
    VFloat tmp;
    tmp.mAsVector = _mm_min_ps( v0.mAsVector, _mm_set1_ps(v1) );
    return tmp;
}

__forceinline VFloat Max( const VFloat &v0, const float v1 )
{
    VFloat tmp;
...
__forceinline VFloat operator/( const float num, const VFloat den )
{
    VFloat tmp;
...
__forceinline VInt Max( const VInt &v0, const int v1 )
{
    VInt tmp;
