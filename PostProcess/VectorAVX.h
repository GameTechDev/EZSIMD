...
*/
    ...
    __forceinline float HorizontalSum() const
    {
        return mAsVector.m256_f32[0] + mAsVector.m256_f32[1] + mAsVector.m256_f32[2] + mAsVector.m256_f32[3]
             + mAsVector.m256_f32[4] + mAsVector.m256_f32[5] + mAsVector.m256_f32[6] + mAsVector.m256_f32[7];
    }
...
__forceinline VFloat3 HorizontalSumByFours( VFloat3 pSource[4] )
{
    VFloat3 tmp(0.0f);
/*
    _MM256_TRANSPOSE4_PS( pSource[0].mX, pSource[1].mX, pSource[2].mX, pSource[3].mX );
    tmp.mX = _mm256_add_ps( _mm256_add_ps( _mm256_add_ps( pSource[0].mX, pSource[1].mX ), pSource[2].mX), pSource[3].mX );

    _MM256_TRANSPOSE4_PS( pSource[0].mY, pSource[1].mY, pSource[2].mY, pSource[3].mY );
    tmp.mY = _mm256_add_ps( _mm256_add_ps( _mm256_add_ps( pSource[0].mY, pSource[1].mY ), pSource[2].mY), pSource[3].mY );

    _MM256_TRANSPOSE4_PS( pSource[0].mZ, pSource[1].mZ, pSource[2].mZ, pSource[3].mZ );
    tmp.mZ = _mm256_add_ps( _mm256_add_ps( _mm256_add_ps( pSource[0].mZ, pSource[1].mZ ), pSource[2].mZ), pSource[3].mZ );
*/
    for( int ii=0; ii<4; ii++ )
    {
        tmp.mX.m256_f32[0] = pSource[0].mX.m256_f32[ii];
        tmp.mX.m256_f32[1] = pSource[0].mX.m256_f32[ii+4];
        tmp.mX.m256_f32[2] = pSource[1].mX.m256_f32[ii];
        tmp.mX.m256_f32[3] = pSource[1].mX.m256_f32[ii+4];
        tmp.mX.m256_f32[4] = pSource[2].mX.m256_f32[ii];
        tmp.mX.m256_f32[5] = pSource[2].mX.m256_f32[ii+4];
        tmp.mX.m256_f32[6] = pSource[3].mX.m256_f32[ii];
        tmp.mX.m256_f32[7] = pSource[3].mX.m256_f32[ii+4];
        tmp.mX = _mm256_add_ps( _mm256_add_ps( _mm256_add_ps( pSource[ 0 ].mX, pSource[ 1 ].mX ), pSource[ 2 ].mX ), pSource[ 3 ].mX );

        tmp.mY.m256_f32[0] = pSource[0].mY.m256_f32[ii];
        tmp.mY.m256_f32[1] = pSource[0].mY.m256_f32[ii+4];
        tmp.mY.m256_f32[2] = pSource[1].mY.m256_f32[ii];
        tmp.mY.m256_f32[3] = pSource[1].mY.m256_f32[ii+4];
        tmp.mY.m256_f32[4] = pSource[2].mY.m256_f32[ii];
        tmp.mY.m256_f32[5] = pSource[2].mY.m256_f32[ii+4];
        tmp.mY.m256_f32[6] = pSource[3].mY.m256_f32[ii];
        tmp.mY.m256_f32[7] = pSource[3].mY.m256_f32[ii+4];
        tmp.mY = _mm256_add_ps( _mm256_add_ps( _mm256_add_ps( pSource[ 0 ].mY, pSource[ 1 ].mY ), pSource[ 2 ].mY ), pSource[ 3 ].mY );

        tmp.mZ.m256_f32[0] = pSource[0].mZ.m256_f32[ii];
        tmp.mZ.m256_f32[1] = pSource[0].mZ.m256_f32[ii+4];
        tmp.mZ.m256_f32[2] = pSource[1].mZ.m256_f32[ii];
        tmp.mZ.m256_f32[3] = pSource[1].mZ.m256_f32[ii+4];
        tmp.mZ.m256_f32[4] = pSource[2].mZ.m256_f32[ii];
        tmp.mZ.m256_f32[5] = pSource[2].mZ.m256_f32[ii+4];
        tmp.mZ.m256_f32[6] = pSource[3].mZ.m256_f32[ii];
        tmp.mZ.m256_f32[7] = pSource[3].mZ.m256_f32[ii+4];
        tmp.mZ = _mm256_add_ps( _mm256_add_ps( _mm256_add_ps( pSource[ 0 ].mZ, pSource[ 1 ].mZ ), pSource[ 2 ].mZ ), pSource[ 3 ].mZ );
    }
    return tmp;
}
